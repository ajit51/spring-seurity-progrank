...
import com.progrank.security.provider.UserPasrswordAuthProvider;
...
public class AppConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	@Lazy
	UserPasrswordAuthProvider userPasrswordAuthProvider;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.authenticationProvider(userPasrswordAuthProvider)
